...
// TestLoadCORSUnsetUsesDefaultAllowlist pins the fail-closed contract: when
// CORS_ORIGINS is unset, Load returns the default allowlist, so the effective
// policy is decided in the config module alone.
